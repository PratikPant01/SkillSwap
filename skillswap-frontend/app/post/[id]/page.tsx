    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-wrap items-center gap-3 md:gap-5 mb-6 text-blue-200">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 md:w-12 md:h-12 bg-blue-500 rounded-full flex items-center justify-center text-white text-lg md:text-xl">
            {userInitial}
          </div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-semibold text-gray-900">{singleService.username}</p>
